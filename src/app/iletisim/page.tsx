        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              {
                question: 'Ekipman kiralama hizmeti sunuyor musunuz?',
                answer: 'Evet, tüm ekipmanlarımızı kiralama hizmeti sunuyoruz. Günlük, haftalık ve aylık kiralama seçeneklerimiz mevcuttur.'
              },
              {
